...
if __name__ == '__main__':
    ...
    year = 2001
    while year < 2021:
        path_mother = os.path.join('H:\\001zone\\00张家口承德地区\\zc_evf\\cal_zc_evf\\ndvi\\ndvi_band',str(year)) # 输入路径，文件夹
        #path_out = os.path.join('H:\\001zone\\00张家口承德地区\\cal_zc_evf\\month_bands',str(year))  # 输出路径，文件夹
        path_out = ('H:\\001zone\\00张家口承德地区\\zc_evf\\cal_zc_evf\\ndvi\\ave_year_ndvi') # 输出路径，文件夹
        ...
        for file in glob.glob('*.tiff'):
            ...
            #B2 = Rrs_2 * 1.0  # / 10000
            #B3 = Rrs_3 * 1.0  # / 10000
        B13 = (B1 + B2 + B3 + B4 + B5 + B6 + B7 + B8 + B9 + B10 + B11 + B12)/12
        outpath_1 = path_out + os.sep + str(year)  + '_ave_year_ndvi.tiff'
